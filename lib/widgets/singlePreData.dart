...
class SinglePreDataList extends StatefulWidget {
  DateTime selectedDate;
  SinglePreDataList({super.key, required this.selectedDate});

  @override
  State<SinglePreDataList> createState() => _SinglePreDataListState();
}

class _SinglePreDataListState extends State<SinglePreDataList> {
